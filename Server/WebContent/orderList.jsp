...
<jsp:directive.page
	import="java.util.List , java.util.Map , com.changshuai.order.Order" />
								...
								<tr>
									<td><table width="100%" border="0" cellspacing="0"
											...
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1">订单管理</span>
												</td>
											</tr>
										</table></td>
									<td><div align="right">
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10"> 总价格</span>
							</div></td>
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10"> 账单状态</span>
							</div></td>
						<td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
					...
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF"><div align="center"
								...
								<a href="order.do?method=del&id=<%=order.getId()%>"> 删除</a>
							</div></td>
					</tr>
					<%
		}
