...
<body>
	...
	<div id="body">
		<form method="post" id="demo" action="updatePassword.do">
			...
			<p>
				原密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="oldPassword"
					id="oldPassword" type="password" />
			</p>
			<p>
				新密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="newPassword"
					id="newPassword" type="password" />
			</p>
			<p>
				重复新密码<input name="secondPassword" dataType="Repeat" to="newPassword"
					msg="两次输入的密码不一致" type="password" />
			</p>
			<p>
				<input name="Submit" type="submit" value="确定"
					onclick="return onSubmit();" /> <input type="button" value="关闭"
	...
	<script language="javascript">
			function onSubmit() {
				...
				if (document.getElementById('newPassword').value != document
						.getElementById('secondPassword').value) {
